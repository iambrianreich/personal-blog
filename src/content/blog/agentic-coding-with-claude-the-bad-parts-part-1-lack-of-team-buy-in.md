...
description: "Exploring the challenges of introducing AI-assisted development tools to a team that isn't fully aligned."
pubDate: 2025-07-31
category: "ai-agentic-coding"
heroImage: "../../assets/images/blog/agentic-coding-with-claude-the-bad-parts-part-1-lack-of-team-buy-in/team-ai-disagreement.png"
heroImageAlt: "Agentic Coding with Claude: The Bad Parts, Part 1 - Lack of Team Buy-In"
draft: false
---

Hi, I'm Brian. You may remember me from such posts as [Using Claude Code to Automatically Fix Security Issues Discovered by Snyk](/blog/using-claude-code-to-automatically-fix-security-issues-discovered-by-snyk/), and [Teaching Claude Code About Test Coverage](/blog/claude-code-test-coverage/). I probably sound pretty bullish about the future of AI augmented coding.
...
- **The AI Amish.** _AI is the devil! AI will destroy the environment, tank the economy for all but the 1% of the 1%, atrophy the skills of human developers, erode privacy, and bring shame on you, your family, and your cow! But also it's completely useless and produces awful slop._

**Let's face it.** When you start using AI tools, the code you submit has a scent of AI on it. That doesn't mean it's _bad code_. It means that folks familiar with your codebase sense something slightly off about it. They know it's isn't the _artisanal, hand-crafted slop_ you usually submit to PR. **It's AI slop!**
...
I live professionally in the quality consulting space and they often say _"there are no people problems, only process problems."_

`<rant>` (But _that's definitely a little_ **bullshit, isn't it?** There are **totally** people problems. I mean every company has a department _specifically_ for people problems, [at least for now](https://www.moveworks.com/). So don't tell me there's no such thing as people problems when it's clearly a marketable skill to be able to ruin someone professionally without shifting your facial expression.) `</rant>`
...
If your team does peer review (PR), have a [PR Policy](https://google.github.io/eng-practices/review/reviewer/standard.html) that defines what appropriate and inappropriate feedback and change requests look like. When folks _abuse the policy_ to block AI generated code they don't personally like, fix the policy. When they block AI code they don't personally like in defiance of the policy, rub it in their face.
...
If AI is _that important_ to adopt, then build the team you need to make adoption successful. Don't suffer folks that will throw sand in the gears of the effort. Brutal, but honest.
